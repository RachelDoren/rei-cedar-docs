...
<cdr-doc-example-code-pair repository-href="https://github.com/rei/rei-cedar/tree/18.12.2/src/components/input" :sandbox-data="$page.frontmatter.sandboxData" :backgroundToggle="false" :codeMaxHeight="false" :model="{defaultModel: ''}">
...
<cdr-doc-example-code-pair repository-href="https://github.com/rei/rei-cedar/tree/18.12.2/src/components/input" :sandbox-data="Object.assign({}, $page.frontmatter.sandboxData, {loadIcon: true})" :backgroundToggle="false" :codeMaxHeight="false" :model="{defaultModel: ''}">
