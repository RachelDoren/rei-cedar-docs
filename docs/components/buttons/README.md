---
{
  ...
  "sandboxData": {
    "name": "CdrButton",
    "dependencies": { "@rei/cdr-button": "1.0.3", "@rei/cdr-icon": "^2.0.0"  },
...
<cdr-doc-example-code-pair repository-href="https://github.com/rei/rei-cedar/tree/18.07.2/src/components/button" :sandbox-data="$page.frontmatter.sandboxData">
