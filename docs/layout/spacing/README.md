...
Use the space utility classes if you want to apply the Cedar spacing convention within your markup instead of in stylesheets. For a list of avaiable utility classes, visit [CSS Utility Class](../../components/utilities/).
